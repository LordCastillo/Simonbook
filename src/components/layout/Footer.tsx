      ...
      <div className="container mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-20 items-start mb-16">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-beige/40 text-[0.9rem] leading-[1.8] max-w-[300px] mx-auto lg:mx-0">
          ...
          <div className="text-center">
            <h4 className="font-ui text-[0.7rem] tracking-[3px] uppercase text-gold mb-8">Navigation</h4>
              ...
              {links.map((link) => (
                <li key={link.name}>
                  <a 
                    ...
                    className="text-beige/50 hover:text-gold transition-colors duration-300 font-ui text-[0.75rem] tracking-[1px] uppercase"
                  >
                    {link.name}
                  </a>
                </li>
          ...
          <div className="text-center lg:text-right">
            <h4 className="font-ui text-[0.7rem] tracking-[3px] uppercase text-gold mb-8">Connect</h4>
            <div className="flex justify-center lg:justify-end gap-5">
              {socials.map((social, i) => (
                <a 
                  key={i} 
                  href={social.href} 
                  className="w-10 h-10 rounded-full border border-gold/20 flex items-center justify-center text-beige/40 hover:text-gold hover:border-gold transition-all duration-300 bg-gold/5"
                >
        ...
        <div className="pt-10 border-t border-gold/5 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="font-ui text-[0.65rem] tracking-[2px] text-beige/20 uppercase">
